...
public class LiLACRenderer {
    ...
    public static String render(String lilac) throws LiLACParsingException {
        ...
        // 텍스트 크기 적용
        lilac = font_size.matcher(lilac).replaceAll(matchResult -> "<span class=\"lilac\" style=\"font-size: " + Math.floor(Integer.parseInt(matchResult.group(1)) + 11) / 10 + "em;\">" + matchResult.group(2) + "</span>");
